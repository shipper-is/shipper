...
If a git repo is initialized, read and follow [./GIT.md](./GIT.md) for branching and bug file location. Also ask whether the user wants a PR created automatically when finished (if not already decided).
